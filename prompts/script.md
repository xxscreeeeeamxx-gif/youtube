...
- 構成: ①フック（15秒で「見ないと損」と思わせる）→ ②問題提起 → ③本編2〜3章（章ごとに1つの発見）→ ④締め。
  **まとめ・振り返りの章は作らない**。締めの章は title を空文字にして、
  行動を促す一言 → 逆説の一言 → 登録呼びかけ、の3〜4カットで一気に終わる
- 一人語り。**饒舌に畳みかける＋視聴者を強めに煽る**のがこのチャンネルの芸風。短文をリズムよく重ね、
  視聴者に直接踏み込む（「〜していませんか？」「心当たり、ありますよね」「ええ、あなたです」
  「目をそらさない」「やらない理由、ありますか」）。
  各章に2回程度、視聴者への煽り・名指しの呼びかけを入れる。遠慮しない。
  ただし上から目線にせずユーモアで中和する（煽った直後に笑いか救いを置く）
