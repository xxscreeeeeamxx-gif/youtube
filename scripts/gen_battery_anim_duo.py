...
P1S = 15.65   # 充電開始（充電は、この粒を… の頭）
P2S = 25.93   # 放電開始（そう。スマホを使うときは… の頭）
P3S = 35.42   # 満タン開始（じゃあ満タンは… の頭）
WARN_T = 48.43  # 劣化警告テキスト（高い電圧がかかり続ける… の頭）
DUR = 57.5    # 全体尺（span合計 56.2 + 余白。ループで巻き戻さないため）
