...
P1S = 16.31   # 充電開始（充電は、この粒を… の頭）
P2S = 26.82   # 放電開始（そうだよ。スマホを使うときは… の頭）
P3S = 36.57   # 満タン開始（じゃあ満タンは… の頭）
WARN_T = 49.87  # 劣化警告テキスト（高い電圧がかかり続ける… の頭）
DUR = 59.0    # 全体尺（span合計 57.9 + 余白。ループで巻き戻さないため）
