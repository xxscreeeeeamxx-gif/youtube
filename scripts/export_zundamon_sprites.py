#!/usr/bin/env python3
"""坂本アヒル氏の「ずんだもん立ち絵素材」PSDから感情別PNGを書き出す。
...
出力: assets/characters/zundamon/<emotion>.png
...
EMOTION_LAYERS = {
    "normal":    {"!眉": "*普通眉", "!目": "*目セット", "!口": "*むふ"},
    "happy":     {"!眉": "*普通眉", "!目": "*にっこり", "!口": "*んへー"},
    "surprised": {"!眉": "*上がり眉", "!目": "*〇〇", "!口": "*おほお"},
    "thinking":  {"!眉": "*困り眉1", "!目": "*上向き", "!口": "*△"},
    "angry":     {"!眉": "*怒り眉", "!目": "*ジト目", "!口": "*むー"},
    "sad":       {"!眉": "*困り眉2", "!目": "*なごみ目", "!口": "*んー"},
}
OUT_DIR = Path("assets/characters/zundamon")
MARGIN = 12  # bbox切り抜きの余白(px)
